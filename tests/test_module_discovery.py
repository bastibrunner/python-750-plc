...
def test_module_config_with_matching_config(modbus_mock_with_modules: MockModbusTcpClient) -> None:
    ...
    modules_config = [
        ModuleConfig(name="test_module_1", type="352", index=0, update_interval=100, channels=[]),
        ModuleConfig(name="test_module_2", type="559", index=1, update_interval=101, channels=[]),
        ...
        ModuleConfig(name="test_module_5", type="DO", index=4, update_interval=104, channels=[]),
        ModuleConfig(name="test_module_6", type="DI", index=5, update_interval=105, channels=[]),
        ModuleConfig(name="test_module_7", type="DI", index=6, update_interval=106, channels=[]),
        ModuleConfig(name="test_module_8", type="459", index=7, update_interval=107, channels=[]),
        ModuleConfig(name="test_module_9", type="453", index=8, update_interval=108, channels=[]),
        ModuleConfig(name="test_module_10", type="460", index=9, update_interval=109, channels=[]),
        ModuleConfig(name="test_module_11", type="451", index=10, update_interval=110, channels=[]),
    ...
    assert hub.modules[0].config.update_interval == 100, "Module 1 should have polling interval 100"
    ...
    assert hub.modules[1].config.update_interval == 101, "Module 2 should have polling interval 101"
    ...
    assert hub.modules[3].config.update_interval == 103, "Module 4 should have polling interval 103"
    ...
    assert hub.modules[5].config.update_interval == 105, "Module 6 should have polling interval 105"
    ...
    assert hub.modules[7].config.update_interval == 107, "Module 8 should have polling interval 107"
    ...
    assert hub.modules[8].config.update_interval == 108, "Module 9 should have polling interval 108"
    ...
    assert hub.modules[9].config.update_interval == 109, "Module 10 should have polling interval 109"
    ...
    assert hub.modules[10].config.update_interval == 110, "Module 11 should have polling interval 110"
    ...
    assert hub.modules[11].config.update_interval == 111, "Module 12 should have polling interval 111"
    ...
    assert hub.modules[12].config.update_interval == 112, "Module 13 should have polling interval 112"
...
def test_module_config_with_mismatching_config_indexmismatch(modbus_mock_with_modules: MockModbusTcpClient) -> None:
    """Test module config with mismatching config."""
    modules_config = [
        ModuleConfig(name="test_module_1", type="352", index=12, update_interval=100, channels=[]),
        ModuleConfig(name="test_module_2", type="559", index=11, update_interval=101, channels=[]),
        ModuleConfig(name="test_module_3", type="559", index=10, update_interval=102, channels=[]),
        ModuleConfig(name="test_module_4", type="DO", index=9, update_interval=103, channels=[]),
        ModuleConfig(name="test_module_5", type="DO", index=8, update_interval=104, channels=[]),
        ModuleConfig(name="test_module_6", type="DI", index=7, update_interval=105, channels=[]),
        ModuleConfig(name="test_module_7", type="DI", index=6, update_interval=106, channels=[]),
        ModuleConfig(name="test_module_8", type="459", index=5, update_interval=107, channels=[]),
        ModuleConfig(name="test_module_9", type="453", index=4, update_interval=108, channels=[]),
        ModuleConfig(name="test_module_10", type="460", index=3, update_interval=109, channels=[]),
        ModuleConfig(name="test_module_11", type="451", index=2, update_interval=110, channels=[]),
        ModuleConfig(name="test_module_12", type="404", index=1, update_interval=111, channels=[]),
